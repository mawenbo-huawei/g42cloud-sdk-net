...
namespace G42Cloud.SDK.Vpc.V3.Model
{
    ...
    public class UpdateAddressGroupRequestBody 
    {
        ...
        public UpdateAddressGroupOption AddressGroup { get; set; }
        ...
        {
            return this.Equals(input as UpdateAddressGroupRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAddressGroupRequestBody input)
        {
            if (input == null)
                return false;
