...
namespace G42Cloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowAddressGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowAddressGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowAddressGroupResponse input)
        {
            if (input == null)
                return false;
