...
namespace G42Cloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateSecurityGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateSecurityGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSecurityGroupResponse input)
        {
            if (input == null)
                return false;
