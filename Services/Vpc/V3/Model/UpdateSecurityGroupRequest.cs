...
namespace G42Cloud.SDK.Vpc.V3.Model
{
    ...
    public class UpdateSecurityGroupRequest 
    {
        ...
        public UpdateSecurityGroupRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateSecurityGroupRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateSecurityGroupRequest input)
        {
            if (input == null)
                return false;
