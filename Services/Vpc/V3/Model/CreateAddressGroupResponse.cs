...
namespace G42Cloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateAddressGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateAddressGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAddressGroupResponse input)
        {
            if (input == null)
                return false;
