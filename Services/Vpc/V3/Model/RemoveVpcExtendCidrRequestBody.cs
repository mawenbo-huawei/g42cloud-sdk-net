...
namespace G42Cloud.SDK.Vpc.V3.Model
{
    ...
    public class RemoveVpcExtendCidrRequestBody 
    {
        ...
        public RemoveExtendCidrOption Vpc { get; set; }
        ...
        {
            return this.Equals(input as RemoveVpcExtendCidrRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(RemoveVpcExtendCidrRequestBody input)
        {
            if (input == null)
                return false;
