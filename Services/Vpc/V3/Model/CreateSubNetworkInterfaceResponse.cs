...
namespace G42Cloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateSubNetworkInterfaceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateSubNetworkInterfaceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateSubNetworkInterfaceResponse input)
        {
            if (input == null)
                return false;
