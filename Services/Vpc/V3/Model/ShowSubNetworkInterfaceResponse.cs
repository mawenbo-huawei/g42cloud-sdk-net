...
namespace G42Cloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSubNetworkInterfaceResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowSubNetworkInterfaceResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSubNetworkInterfaceResponse input)
        {
            if (input == null)
                return false;
