...
namespace G42Cloud.SDK.Vpc.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateAddressGroupResponse : SdkResponse
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateAddressGroupResponse {\n");
        ...
        {
            return this.Equals(input as UpdateAddressGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateAddressGroupResponse input)
        {
            if (input == null)
                return false;
