...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronShowFirewallPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as NeutronShowFirewallPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronShowFirewallPolicyResponse input)
        {
            if (input == null)
                return false;
