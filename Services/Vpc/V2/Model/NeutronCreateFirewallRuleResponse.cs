...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronCreateFirewallRuleResponse : SdkResponse
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NeutronCreateFirewallRuleResponse {\n");
        ...
        {
            return this.Equals(input as NeutronCreateFirewallRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronCreateFirewallRuleResponse input)
        {
            if (input == null)
                return false;
