...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronAddFirewallRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as NeutronAddFirewallRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronAddFirewallRuleResponse input)
        {
            if (input == null)
                return false;
