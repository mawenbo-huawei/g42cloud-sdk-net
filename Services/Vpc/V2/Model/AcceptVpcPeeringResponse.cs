...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class AcceptVpcPeeringResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as AcceptVpcPeeringResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AcceptVpcPeeringResponse input)
        {
            if (input == null)
                return false;
