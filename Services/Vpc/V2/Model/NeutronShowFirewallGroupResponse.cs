...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronShowFirewallGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as NeutronShowFirewallGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronShowFirewallGroupResponse input)
        {
            if (input == null)
                return false;
