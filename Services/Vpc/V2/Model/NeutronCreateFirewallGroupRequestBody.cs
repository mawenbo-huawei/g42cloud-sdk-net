...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    public class NeutronCreateFirewallGroupRequestBody 
    {
        ...
        public NeutronCreateFirewallGroupOption FirewallGroup { get; set; }
        ...
        {
            return this.Equals(input as NeutronCreateFirewallGroupRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronCreateFirewallGroupRequestBody input)
        {
            if (input == null)
                return false;
