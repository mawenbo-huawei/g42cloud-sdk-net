...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateVpcPeeringResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateVpcPeeringResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateVpcPeeringResponse input)
        {
            if (input == null)
                return false;
