...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    public class NeutronAddFirewallRuleRequest 
    {
        ...
        public NeutronInsertFirewallRuleRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as NeutronAddFirewallRuleRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronAddFirewallRuleRequest input)
        {
            if (input == null)
                return false;
