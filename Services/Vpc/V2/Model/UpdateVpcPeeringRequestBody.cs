...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    public class UpdateVpcPeeringRequestBody 
    {
        ...
        public UpdateVpcPeeringOption Peering { get; set; }
        ...
        {
            return this.Equals(input as UpdateVpcPeeringRequestBody);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateVpcPeeringRequestBody input)
        {
            if (input == null)
                return false;
