...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronUpdateSecurityGroupResponse : SdkResponse
    {

        [JsonProperty("security_group", NullValueHandling = NullValueHandling.Ignore)]
        public NeutronSecurityGroup SecurityGroup { get; set; }
        ...
        {
            return this.Equals(input as NeutronUpdateSecurityGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronUpdateSecurityGroupResponse input)
        {
            if (input == null)
                return false;
