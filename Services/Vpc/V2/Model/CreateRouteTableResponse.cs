...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateRouteTableResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateRouteTableResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRouteTableResponse input)
        {
            if (input == null)
                return false;
