...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronShowSecurityGroupRuleResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as NeutronShowSecurityGroupRuleResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronShowSecurityGroupRuleResponse input)
        {
            if (input == null)
                return false;
