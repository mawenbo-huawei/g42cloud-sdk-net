...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    public class NeutronRemoveFirewallRuleRequest 
    {
        ...
        public NeutronRemoveFirewallRuleRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as NeutronRemoveFirewallRuleRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronRemoveFirewallRuleRequest input)
        {
            if (input == null)
                return false;
