...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronShowSecurityGroupResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as NeutronShowSecurityGroupResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronShowSecurityGroupResponse input)
        {
            if (input == null)
                return false;
