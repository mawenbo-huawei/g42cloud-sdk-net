...
namespace G42Cloud.SDK.Vpc.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class NeutronCreateFirewallPolicyResponse : SdkResponse
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NeutronCreateFirewallPolicyResponse {\n");
        ...
        {
            return this.Equals(input as NeutronCreateFirewallPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(NeutronCreateFirewallPolicyResponse input)
        {
            if (input == null)
                return false;
