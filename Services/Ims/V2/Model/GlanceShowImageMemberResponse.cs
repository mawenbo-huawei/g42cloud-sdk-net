...
namespace G42Cloud.SDK.Ims.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GlanceShowImageMemberResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GlanceShowImageMemberResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GlanceShowImageMemberResponse input)
        {
            if (input == null)
                return false;
