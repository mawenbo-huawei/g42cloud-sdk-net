...
namespace G42Cloud.SDK.Ims.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GlanceUpdateImageResponse : SdkResponse
    {
        ...
        public class PlatformEnum
        {
            ...
            /// </summary>
            public static readonly PlatformEnum ORACLELINUX = new PlatformEnum("OracleLinux");
        ...
        [JsonConverter(typeof(EnumClassConverter<IsOffshelvedEnum>))]
        public class IsOffshelvedEnum
        {
            /// <summary>
            /// Enum TRUE for value: true
            /// </summary>
            public static readonly IsOffshelvedEnum TRUE = new IsOffshelvedEnum("true");

            /// <summary>
            /// Enum FALSE for value: false
            /// </summary>
            public static readonly IsOffshelvedEnum FALSE = new IsOffshelvedEnum("false");

            private static readonly Dictionary<string, IsOffshelvedEnum> StaticFields =
            new Dictionary<string, IsOffshelvedEnum>()
            {
                { "true", TRUE },
                { "false", FALSE },
            };
            ...
            public override bool Equals(object obj)
            {
                ...
                if (this.Equals(obj as IsOffshelvedEnum))
                {
                    return true;
                }
            ...
            public bool Equals(IsOffshelvedEnum obj)
            {
                if ((object)obj == null)
                {
                    return false;
        ...
        {
            return this.Equals(input as GlanceUpdateImageResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GlanceUpdateImageResponse input)
        {
            if (input == null)
                return false;
