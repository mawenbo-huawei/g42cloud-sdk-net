...
namespace G42Cloud.SDK.Ims.V2.Model
{
    ...
    public class GlanceUpdateImageRequest 
    {
        ...
        public List<GlanceUpdateImageRequestBody> Body { get; set; }
        ...
        {
            return this.Equals(input as GlanceUpdateImageRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GlanceUpdateImageRequest input)
        {
            if (input == null)
                return false;
