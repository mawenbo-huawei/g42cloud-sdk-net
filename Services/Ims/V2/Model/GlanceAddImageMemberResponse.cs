...
namespace G42Cloud.SDK.Ims.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class GlanceAddImageMemberResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as GlanceAddImageMemberResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(GlanceAddImageMemberResponse input)
        {
            if (input == null)
                return false;
