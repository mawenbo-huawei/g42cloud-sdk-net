...
namespace G42Cloud.SDK.Ecs.V2.Model
{
    ...
    public class AssociateServerVirtualIpRequest 
    {
        ...
        public AssociateServerVirtualIpRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AssociateServerVirtualIpRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AssociateServerVirtualIpRequest input)
        {
            if (input == null)
                return false;
