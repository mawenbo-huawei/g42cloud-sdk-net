...
namespace G42Cloud.SDK.Ecs.V2.Model
{
    ...
    public class BatchAttachSharableVolumesRequest 
    {
        ...
        public BatchAttachSharableVolumesRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchAttachSharableVolumesRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchAttachSharableVolumesRequest input)
        {
            if (input == null)
                return false;
