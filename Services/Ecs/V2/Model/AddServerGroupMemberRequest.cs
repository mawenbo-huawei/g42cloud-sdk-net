...
namespace G42Cloud.SDK.Ecs.V2.Model
{
    ...
    public class AddServerGroupMemberRequest 
    {
        ...
        public AddServerGroupMemberRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as AddServerGroupMemberRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(AddServerGroupMemberRequest input)
        {
            if (input == null)
                return false;
