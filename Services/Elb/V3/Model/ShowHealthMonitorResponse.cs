...
namespace G42Cloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowHealthMonitorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowHealthMonitorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowHealthMonitorResponse input)
        {
            if (input == null)
                return false;
