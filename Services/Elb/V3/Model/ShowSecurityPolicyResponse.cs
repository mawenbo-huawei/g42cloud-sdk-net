...
namespace G42Cloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowSecurityPolicyResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowSecurityPolicyResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowSecurityPolicyResponse input)
        {
            if (input == null)
                return false;
