...
namespace G42Cloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class UpdateHealthMonitorResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as UpdateHealthMonitorResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateHealthMonitorResponse input)
        {
            if (input == null)
                return false;
