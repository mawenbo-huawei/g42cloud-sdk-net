...
namespace G42Cloud.SDK.Elb.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class BatchDeleteIpListResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as BatchDeleteIpListResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteIpListResponse input)
        {
            if (input == null)
                return false;
