...
namespace G42Cloud.SDK.Cdn.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ShowHistoryTasksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ShowHistoryTasksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowHistoryTasksResponse input)
        {
            if (input == null)
                return false;
