...
namespace G42Cloud.SDK.Cdn.V1.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CreateRefreshTasksResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as CreateRefreshTasksResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateRefreshTasksResponse input)
        {
            if (input == null)
                return false;
