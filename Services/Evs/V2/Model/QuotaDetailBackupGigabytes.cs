...
namespace G42Cloud.SDK.Evs.V2.Model
{
    ...
    /// </summary>
    public class QuotaDetailBackupGigabytes 
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuotaDetailBackupGigabytes {\n");
        ...
        {
            return this.Equals(input as QuotaDetailBackupGigabytes);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(QuotaDetailBackupGigabytes input)
        {
            if (input == null)
                return false;
