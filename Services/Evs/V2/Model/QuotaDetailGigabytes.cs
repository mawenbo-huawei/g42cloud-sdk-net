...
namespace G42Cloud.SDK.Evs.V2.Model
{
    ...
    /// </summary>
    public class QuotaDetailGigabytes 
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuotaDetailGigabytes {\n");
        ...
        {
            return this.Equals(input as QuotaDetailGigabytes);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(QuotaDetailGigabytes input)
        {
            if (input == null)
                return false;
