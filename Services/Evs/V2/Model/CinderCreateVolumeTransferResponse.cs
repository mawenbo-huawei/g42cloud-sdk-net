...
namespace G42Cloud.SDK.Evs.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class CinderCreateVolumeTransferResponse : SdkResponse
    {

        [JsonProperty("transfer", NullValueHandling = NullValueHandling.Ignore)]
        public CreateVolumeTransferDetail Transfer { get; set; }
        ...
        {
            return this.Equals(input as CinderCreateVolumeTransferResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CinderCreateVolumeTransferResponse input)
        {
            if (input == null)
                return false;
