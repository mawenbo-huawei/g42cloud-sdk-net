...
namespace G42Cloud.SDK.Evs.V2.Model
{
    ...
    public class BatchDeleteVolumeTagsRequest 
    {
        ...
        public BatchDeleteVolumeTagsRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchDeleteVolumeTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchDeleteVolumeTagsRequest input)
        {
            if (input == null)
                return false;
