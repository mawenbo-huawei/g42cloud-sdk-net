...
namespace G42Cloud.SDK.Evs.V2.Model
{
    ...
    public class QuotaDetailPerVolumeGigabytes 
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuotaDetailPerVolumeGigabytes {\n");
        ...
        {
            return this.Equals(input as QuotaDetailPerVolumeGigabytes);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(QuotaDetailPerVolumeGigabytes input)
        {
            if (input == null)
                return false;
