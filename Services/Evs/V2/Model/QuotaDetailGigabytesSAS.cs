...
namespace G42Cloud.SDK.Evs.V2.Model
{
    ...
    /// </summary>
    public class QuotaDetailGigabytesSAS 
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QuotaDetailGigabytesSAS {\n");
        ...
        {
            return this.Equals(input as QuotaDetailGigabytesSAS);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(QuotaDetailGigabytesSAS input)
        {
            if (input == null)
                return false;
