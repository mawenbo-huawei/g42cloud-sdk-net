...
namespace G42Cloud.SDK.Smn.V2.Model
{
    ...
    /// Response Object
    /// </summary>
    public class ListSubscriptionsByTopicResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as ListSubscriptionsByTopicResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ListSubscriptionsByTopicResponse input)
        {
            if (input == null)
                return false;
