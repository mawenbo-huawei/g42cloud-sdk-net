...
namespace G42Cloud.SDK.Smn.V2.Model
{
    ...
    public class UpdateMessageTemplateRequest 
    {
        ...
        public UpdateMessageTemplateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as UpdateMessageTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(UpdateMessageTemplateRequest input)
        {
            if (input == null)
                return false;
