...
namespace G42Cloud.SDK.Ces.V1.Model
{
    ...
    public class CreateAlarmTemplateRequest 
    {
        ...
        public CreateAlarmTemplateRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as CreateAlarmTemplateRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CreateAlarmTemplateRequest input)
        {
            if (input == null)
                return false;
