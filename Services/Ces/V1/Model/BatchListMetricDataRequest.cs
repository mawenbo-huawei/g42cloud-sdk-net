...
namespace G42Cloud.SDK.Ces.V1.Model
{
    ...
    public class BatchListMetricDataRequest 
    {
        ...
        public BatchListMetricDataRequestBody Body { get; set; }
        ...
        {
            return this.Equals(input as BatchListMetricDataRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchListMetricDataRequest input)
        {
            if (input == null)
                return false;
