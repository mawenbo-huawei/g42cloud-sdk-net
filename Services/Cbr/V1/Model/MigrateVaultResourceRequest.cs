...
namespace G42Cloud.SDK.Cbr.V1.Model
{
    ...
    public class MigrateVaultResourceRequest 
    {
        ...
        public VaultMigrateResourceReq Body { get; set; }
        ...
        {
            return this.Equals(input as MigrateVaultResourceRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(MigrateVaultResourceRequest input)
        {
            if (input == null)
                return false;
