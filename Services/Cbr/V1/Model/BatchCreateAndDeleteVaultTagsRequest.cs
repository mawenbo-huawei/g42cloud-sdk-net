...
namespace G42Cloud.SDK.Cbr.V1.Model
{
    ...
    public class BatchCreateAndDeleteVaultTagsRequest 
    {
        ...
        public BulkCreateAndDeleteVaultTagsReq Body { get; set; }
        ...
        {
            return this.Equals(input as BatchCreateAndDeleteVaultTagsRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(BatchCreateAndDeleteVaultTagsRequest input)
        {
            if (input == null)
                return false;
