...
namespace G42Cloud.SDK.Cbr.V1.Model
{
    ...
    /// Request Object
    /// </summary>
    public class ShowMemberDetailRequest 
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShowMemberDetailRequest {\n");
        ...
        {
            return this.Equals(input as ShowMemberDetailRequest);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(ShowMemberDetailRequest input)
        {
            if (input == null)
                return false;
