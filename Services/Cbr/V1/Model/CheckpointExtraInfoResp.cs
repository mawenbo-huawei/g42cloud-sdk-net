...
namespace G42Cloud.SDK.Cbr.V1.Model
{
    ...
    public class CheckpointExtraInfoResp 
    {
        ...
        {
            return this.Equals(input as CheckpointExtraInfoResp);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(CheckpointExtraInfoResp input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RetentionDuration == input.RetentionDuration ||
                    (this.RetentionDuration != null &&
                    this.RetentionDuration.Equals(input.RetentionDuration))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.RetentionDuration != null)
                    hashCode = hashCode * 59 + this.RetentionDuration.GetHashCode();
                return hashCode;
            }
        }
    }
