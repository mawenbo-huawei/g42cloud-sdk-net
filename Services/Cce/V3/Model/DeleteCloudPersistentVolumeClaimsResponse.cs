...
namespace G42Cloud.SDK.Cce.V3.Model
{
    ...
    /// Response Object
    /// </summary>
    public class DeleteCloudPersistentVolumeClaimsResponse : SdkResponse
    {
        ...
        {
            return this.Equals(input as DeleteCloudPersistentVolumeClaimsResponse);
        }

        /// <summary>
        /// Returns true if objects are equal
        /// </summary>
        public bool Equals(DeleteCloudPersistentVolumeClaimsResponse input)
        {
            if (input == null)
                return false;
